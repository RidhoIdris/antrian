...
<div class="modal fade" id="modal" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form method="POST" id="form" action="{{ route('master-spesialis.store')}}">
        <fieldset>
                @csrf
                <div class="row">
                    <div class="form-group col-12">
                            <input type="hidden" name="id">
                            <input type="text" autocomplete="off" class="form-control" placeholder="Nama Spesialis" name="nama_spesialis">
                    </div>
                </div>
            </div>
            <!-- Modal footer -->

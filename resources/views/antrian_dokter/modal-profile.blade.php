        ...
        <div class="modal-body" style=" height: calc(100vh - 300px);; overflow-y: scroll !important;">
            <div class="row">
                ...
                <div class="form-group col-6">
                    <label for="name"  class="control-label">Tipe Pembayaran</label>
                    <input type="text"readonly id="tipe_pembayaran" class="form-control">
                </div>
                <div class="form-group col-6">
                    <label for="name"  class="control-label">Nama Asuransi</label>
                    <input type="text"readonly id="nama_asuransi" class="form-control">
                </div>
                <div class="form-group col-6">
                ...
                <div class="form-group col-6">
                    <label for="name"  class="control-label">Foto Asuransi</label>
                    <br>
                    <img style="width:200px;height:200px;" id="asuransi_pasien" alt="">
                </div>
            </div>
        </div>
        <!-- Modal footer -->
        <div class="modal-footer">
            <button type="button" id="close" class="btn btn-prmary">Close</button>
        </div>
        </div>
    </div>
</div>
